## Open-Source Hardware Root of Trust [[1]](#ref-1)

Open Se Cura builds on the open-source OpenTitan hardware root of trust (HRoT) and offers several key contributions:

1) Auditability: the transparency of OpenTitan enables anyone to examine, evaluate, and contribute to its design and documentation, fostering the development of a fully auditable and dependable Silicon RoT. 
...
<img src="/images/research/hwsecurity/open_se_cura.png" alt="Open Se Cura chip and measurement setup" style="display:block; margin: 0 auto; width:60%; max-width:720px;" />
